...
import { ClosingPipeline } from "@/components/closing/ClosingPipeline";
      ...
      <div className="space-y-4">
        ...
        <ClientOnly fallback={<p className="py-10 text-center text-sm text-muted-foreground">Loading closing mission…</p>}>
          <Tabs defaultValue="pipeline">
            <TabsList>
              <TabsTrigger value="pipeline">Closing Pipeline</TabsTrigger>
              <TabsTrigger value="promises">Promise Board</TabsTrigger>
            </TabsList>
